...
public class PokerMachine {
    ...
    public boolean shuffleOption() throws NewDeckException
    {
        boolean shuffled = false;
        System.out.println("Do you want to shuffle cards? (yes/no)");
        ...
        if (shuffled == false) {
            throw new NewDeckException("deck is not shuffled");
        }
